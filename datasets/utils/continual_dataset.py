...
def store_masked_loaders(train_dataset: datasets, test_dataset: datasets, memory_dataset: datasets, 
    ...
    train_loader = DataLoader(train_dataset,
                              batch_size=setting.args.train.batch_size, shuffle=True, num_workers=4, pin_memory=True)
    test_loader = DataLoader(test_dataset,
                             batch_size=setting.args.train.batch_size, shuffle=False, num_workers=4, pin_memory=True)
...
def store_domain_loaders(train_dataset: datasets, test_dataset: datasets, memory_dataset: datasets, 
                    setting: ContinualDataset) -> Tuple[DataLoader, DataLoader]:
    """
    Divides the dataset into tasks.
    :param train_dataset: train dataset
