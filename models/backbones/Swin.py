...
class SwinTransformer(nn.Module):
    def __init__(self, *, hidden_dim, layers, heads, channels=3, num_classes=10, head_dim=32, window_size=4,
                 downscaling_factors=(2, 2, 2, 1), relative_pos_embedding=True, args=None):
        super().__init__()
        ...
        self.final_layer_norm = nn.LayerNorm(hidden_dim * 8)
...
def swin_t(num_classes, args, hidden_dim=96, layers=(2, 2, 6, 2), heads=(3, 6, 12, 24), **kwargs):
    return SwinTransformer(hidden_dim=hidden_dim, layers=layers, heads=heads, num_classes=num_classes, args=args, **kwargs)
