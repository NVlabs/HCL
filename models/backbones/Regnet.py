...
Originated from https://github.com/kuangliu/pytorch-cifar/blob/master/models/regnet.py
'''
import torch
...
def RegNetX_200MF(num_classes, args):
    cfg = {
        'depths': [1, 1, 4, 7],
...
def RegNetX_400MF(num_classes, args):
    cfg = {
        'depths': [1, 2, 7, 12],
...
def regnet(num_classes, args):
    return RegNetX_200MF(num_classes, args)
